...
<div class="article-center">
				...
				<center><table style="width:60%; text-align:center;">
					<tr>
						<td><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="background: transparent; border: none;"><img src="img/coffee.png"></button><h3>COFFEE BREAK <br>SAUDÁVEL</h3></td>
						<td><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal3" style="background: transparent; border: none;"><img src="img/nutrieduca.png"></button><h3>NUTRIEDUCA</h3></a></td>
						<td><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal2" style="background: transparent; border: none;"><img src="img/rotulagem.png"></button><h3>ROTULAGEM</h3></a></td>
						<td><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal4" style="background: transparent; border: none;"><img src="img/qnutri.png"></button><h3>Q NUTRI</h3></a></td>
					</tr>
				</table></center>
				<div class="article-left" >
...
respectivos a cada nutriente) e informação aos alérgicos.</p>
		...
		<footer>
			<div id="contato" class="footer-left">
				...
				<a href="https://www.facebook.com/ejenutri" target="_blank"><button type="button" style="background: transparent; border: none;"><img src="img/facebook.png"></button></a>
				<h3>Contato geral:</h3>
